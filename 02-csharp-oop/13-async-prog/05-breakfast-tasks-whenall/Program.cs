...
namespace RS2.BreakfastTasks
{
    class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            await Task.WhenAll(przenjeJaja, przenjeSlanine, pripremanjeTosta);
...
6125 ms: jaja su pripremljena.
6125 ms: slanina je pripremljena.
6125 ms: tost je pripremljen.
>>>Priprema oranz djusa: sipanje.
6126 ms: oranz djus je pripremljen.
6126 ms: dorucak je spreman!
